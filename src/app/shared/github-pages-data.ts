...
import type { NewsArticle, NewsSearchParams } from './models/news.model';
...
export function getGitHubPagesQuotes(ids: string[]): CryptoQuote[] {
  return ids.map((id) => ({
    id,
    ...(QUOTE_FIXTURES[id] ?? {
      priceUsd: 100,
...
export function getGitHubPagesHistory(id: string, days: number): CryptoHistorySeries {
...
export function getGitHubPagesNews(params: NewsSearchParams): NewsArticle[] {
